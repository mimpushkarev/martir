      ...
      <div className="mt-10 text-paragraph [&>*]:mb-6">
        <Accordeon title="Информация по товарам" opened>
          <div className="[&>*]:mb-2">
            ...
            <p>
              <b>Email:</b> <Copy>products@martir.ru</Copy>
            </p>
            <p>
        ...
        <Accordeon title="Информация по покупкам" opened>
          <div className="[&>*]:mb-2">
            ...
            <p>
              ...
              support@martir.ru. Наши специалисты постараются ответить как можно скорее и предоставить всю необходимую
        ...
        <Accordeon title="Обратная связь" opened>
          <div className="[&>*]:mb-2">
            ...
            <p>
              Вы можете связаться с нами по электронной почте info@martir.ru или заполнить форму обратной связи на нашем
              сайте{' '}
